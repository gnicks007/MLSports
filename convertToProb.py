# -*- coding: utf-8 -*-
"""
Created on Sat Aug  6 14:46:29 2016
...
def main():
    ...
    """
    'Categorical Plots
    frame.HomeTeam.value_counts().plot(kind='bar')
    frame.AwayTeam.value_counts().plot(kind='bar')
    frame.Referee.value_counts().plot(kind='bar')
    frame.FTR.value_counts().plot(kind='bar')
    ...
    """scattermatrixPlot(newFrame, ['B1H', 'B1D', 'B1A'])"""
   
    
    """ Convert to Numpy Arrays """
    """ create different combinations of features, 4 at a time """    
